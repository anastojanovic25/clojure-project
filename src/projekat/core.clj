...
(println "Prosečna temperatura:" (avg-temp destinations))
(println "Destinacije do 600€:" (filter-by-budget destinations 600))
(println "Najtoplija destinacija:" (hottest-destination destinations))
